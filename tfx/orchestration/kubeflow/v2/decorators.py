...
def exit_handler(func: types.FunctionType) -> Callable[..., Any]:
  """creates a exit handler from a typehint-annotated Python function.

  This decorator creates a exit handler wrapping the component typehint
  ...
  ```
    from tfx.v1.dsl.components import Parameter
    from tfx.utils import proto_utils
    from tfx.v1.orchestration.experimental import exit_handler
